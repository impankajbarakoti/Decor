...
const BlogDls = () => {
  ...
  const blog = location.state || BlogsData.find((b) => b.id === Number(id));
            ...
            {hasLatest ? (
              ...
              >
                <img
                  ...
                  className="w-full sm:w-36 h-32 sm:h-24 object-cover rounded mb-3 sm:mb-0"
                  loading="lazy"
                />
